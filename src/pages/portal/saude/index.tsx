        ...
        <div className="col-span-full w-full p-4 sm:p-6 space-y-5 max-w-6xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-20 text-gray-400">
              ...
              <p className="text-sm mt-1">Você não tem permissão para acessar o módulo de Saúde.</p>
            </div>
          ) : (
            <>
              {/* ── Header ─────────────────────────────────────── */}
              <div className="flex items-start sm:items-center justify-between gap-3">
                <div>
                  <h1 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                    <span className="text-2xl">❤️</span> Saúde
                  </h1>
                  <p className="text-xs text-gray-400 mt-0.5">Registro clínico de medições dos idosos</p>
                </div>
                <button onClick={() => setShowForm(true)}
                  ...
                  <span className="hidden xs:inline sm:inline">Nova Sessão</span>
