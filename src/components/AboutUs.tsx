  ...
  return (
    <div id='aboutus' className='max-w-[1240px] mx-auto'>
      ...
      <div className='p-8 border m-4 bg-[#b98fb9]'>
        ...
        <p className='mt-3'> Isto só é possível porque temos uma equipe multiprofissional completa para prestar toda a assistência necessária 👩‍⚕️</p>
        <p className='mt-3'>Vem conhecer aqui o nosso lar.</p>
        <p className='mt-3'>Residência-Pousada-Creche🏡</p>
        <p className='mt-3'>Estamos aguardando sua visita. Para mais informações entrar em contato pelo número (21)999269047.</p>
      </div>
    </div>
  )
}
