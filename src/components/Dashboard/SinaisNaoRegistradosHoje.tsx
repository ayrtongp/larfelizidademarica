...
const SinaisNaoRegistradosHoje = () => {
  ...
  const fetchData = async () => {
    const response = await axios.get(`/api/Controller/ResidentesSinaisVitaisController?type=listNotSinaisToday&searchDate=${today}`)
  ...
  return (
    <div className="col-span-full md:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        ...
        <h2 className="font-semibold mt-1 text-xs text-red-500">FALTA CADASTRO: SINAIS VITAIS</h2>
      </header>
      <div className="p-3">
...
export default SinaisNaoRegistradosHoje
